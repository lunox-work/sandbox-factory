...
/**
 * Claude's mark in Anthropic's terracotta. Simple Icons' tracing of the
 * official asterisk, whose twelve arms are irregular by design; a regular
 * burst is not the logo.
 */
function ClaudeIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
...
/** DeepSeek's whale in its blue, from Simple Icons' tracing of the mark. */
